...
- 로그인한 누구나 진행 중인 대회에 원하는 종목으로 **참가 신청** 가능
  ...
  - 종목별 **참가자 명단(닉네임 목록)** 은 누구나 볼 수 있음 (기록·순위는 별도로 주최자/관리자만 열람)
- 주최자는 종목별 참가자의 라운드별 **개별 기록을 직접 입력**하고(종목이 Ao5면 5회, Mo3면 3회), 자동 계산된 **평균 기록**을 확인 가능
...
- 주최자·관리자는 **참가 신청만 마감**하거나(종목·스크램블 등록은 계속 가능), 대회를 **종료**(종목·스크램블 추가 및 참가 신청 모두 중단)하거나 완전히 **삭제** 가능
